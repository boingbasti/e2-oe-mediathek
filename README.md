...
| Rot | Sortiermodus (Gruppenliste) / Zurück (Stream-Liste) |
| Grün | Sortierung wechseln: A-Z / Eigene (nur Gruppenliste) |
| EXIT | Zurück |
...
| MENU | Sammel-Download: aktuelle Seite oder erkannte Staffel (Episodenansicht) |
| EXIT | Zurück / Filter aufheben (Sendung verpasst? / Demnächst) |
| CH+ / CH- | Nächste/vorherige 100 Einträge von der API nachladen |
| Links / Rechts | Innerhalb der aktuell geladenen Liste bildschirmweise weiterspringen |
...
Die Mediathek-Inhalte werden über die API von [mediathekviewweb.de](https://mediathekviewweb.de) ([GitHub](https://github.com/mediathekview/mediathekviewweb)) abgerufen. Die Nutzung wurde mit den Betreibern abgestimmt. Die Live-Streams und Live-Events verwenden hardcodierte HLS-URLs der Sender-CDNs und sind unabhängig von mediathekviewweb.de.
